# @taktikorg/in-aut-iste

[![npm version](https://badge.fury.io/js/@taktikorg/in-aut-iste.svg)](https://badge.fury.io/js/@taktikorg/in-aut-iste)
[![downloads count](https://img.shields.io/npm/dt/@taktikorg/in-aut-iste.svg)](https://www.npmjs.com/package/@taktikorg/in-aut-iste)
[![github-ci](https://github.com/taktikorg/in-aut-iste/actions/workflows/testing.yml/badge.svg)](https://github.com/taktikorg/in-aut-iste/actions/workflows/testing.yml)
...
Next, install `@taktikorg/in-aut-iste`:

```bash
npm install -D @taktikorg/in-aut-iste
```
